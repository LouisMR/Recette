        ...
        fetch(url).then(resp => {
            resp.json().then(data => {
                ...
                for(let i = 0; i < data.recettes.length; i++) {
                    this.titre = data.recettes[2].titre
                    this.id = data.recettes[2].id
                    this.source = data.recettes[2].source
                    this.image = data.recettes[2].image
                    this.temps_preparation = data.recettes[2].temps_preparation
                    this.temps_cuisson = data.recettes[2].temps_cuisson
                    this.temps_attente = data.recettes[2].temps_attente
                    ...
                    this.ingredients = data.recettes[2].ingredients
                    this.preparations = data.recettes[2].preparation
                    this.commentaires = data.recettes[2].commentaires
                    this.etoiles = data.recettes[2].etoiles
                    this.congele = data.recettes[2].se_congele
                }
            })
        })
